...
<P>Nel punto {{u}} piantiamo allora il pelo {{vu}}, il prodotto di {{v}} per {{u}}, che è l’immagine di {{v}} in quella trasformazione. È aderente: {{v}} è perpendicolare a {{1}} e gli angoli si conservano, quindi {{vu}} è perpendicolare a {{u}}. Non manca mai: se {{vu}} fosse zero avrebbe modulo zero, ma {{|vu|=|v|\neq 0}}. E cambia con continuità, perché {{vu}} dipende da {{u}} in modo lineare. Al variare di {{u}} su tutta la sfera i peli ci sono tutti, aderenti e continui: la sfera è pettinata.
