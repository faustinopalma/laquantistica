...
|Useful does not mean compulsory. Nothing assures us that nature lets itself be described in this way. On a clock with a prime number of hours, for instance, addition, multiplication and division all work — there every number other than zero has its own inverse — and there are no real numbers at all: a world made that way cannot be ruled out.</P>
