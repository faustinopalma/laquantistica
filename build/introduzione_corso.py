...
NUOVO_LETTURA = (
    ...
    '<p><span class="it">Si legge su due livelli. Le schede sperimentali — 1, 2, 5, 7, 8, 9 e 12 — si reggono da sole e contengono in tutto un centinaio di formule. Le schede teoriche — 3, 4, 6, 10 e 11 — ricavano i risultati, e sono molto più dense. Si può percorrere tutta la parte sperimentale e tornare alla teoria più tardi, senza perdere il filo. La lettura in ordine resta quella consigliata.</span>'
    '<span class="en">It can be read on two levels. The experimental cards — 1, 2, 5, 7, 8, 9 and 12 — stand on their own and contain about a hundred formulas in all. The theoretical cards — 3, 4, 6, 10 and 11 — derive the results, and are far denser. You can go through the whole experimental path and come back to the theory later, without losing the thread. Reading in order remains what we recommend.</span></p>')
